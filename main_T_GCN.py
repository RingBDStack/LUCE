...
if __name__ == '__main__':
    ...
    parser.add_argument("--gc1_outdim", type=int, default=114)
    parser.add_argument("--gc2_outdim", type=int, default=114)
    parser.add_argument("--seq_len", type=int, default=55)       # 数据中的月数
    parser.add_argument("--house_size", type=int, default=800)   # 每个月的房屋数目
    ...
    # 结果输出文件设置
    result_file_path = 'result_gru/'
    model_file_path = 'model_saved_gru/'
    other_file_path = 'result_gru/others/'
    ...
    train_index = range(37600)
    test_index = range(37600, 44000)
    ...
    model = T_GCN(nfeat=input_dim, gc1_outdim=gc1_outdim, gc2_outdim=gc2_outdim,
