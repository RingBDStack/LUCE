...
if __name__ == '__main__':
    ...
    parser.add_argument("--epoch", type=int, default=1000)        # 训练周期
    ...
    # 结果输出文件设置
    result_file_path = 'result_static/'
    model_file_path = 'model_saved_static/'
    other_file_path = 'result_static/others/'
    ...
    model = GCN2lv_static(nfeat=input_dim, gc1_outdim=gc1_outdim, gc2_outdim=gc2_outdim,
                          dropout=args.dropout, meta_size=meta_size).to(device)
